...
$mail->Username = "gukefei318";   // SMTP username  注意：普通邮件认证不需要加 @域名
$mail->Password = "20040318";        // SMTP password 
$mail->From = "gukefei318@163.com";      // 发件人邮箱
...
smtp_mail('gukefei520@126.com', '欢迎来到cgsir.com！', 'NULL', 'cgsir.com', 'username');
?>
